...
export const FlowerSelector: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Common Flowers */}
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">Common Flowers</h3>
      ...
      {/* Custom Flowers */}
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">Custom Flowers</h3>
        <div className="flex gap-2 mb-4">
          <input
            ...
            placeholder="Add a custom flower..."
          />
          <button
